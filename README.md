...
* Links/lembretes de tags HTML a serem adicionadas para os motores de busca indexar o site de forma orgânica
...
- [x]  Gerar XML com links de todas as páginas e data da ultima atualização do site
